...
const tron_web_1 = require("src/core/blockchain/constants/tron/tron-web");
const blockchain_name_1 = require("src/core/blockchain/models/blockchain-name");
const web3_public_storage_1 = require("src/core/blockchain/web3-public-service/models/web3-public-storage");
const evm_web3_public_1 = require("src/core/blockchain/web3-public-service/web3-public/evm-web3-public/evm-web3-public");
const tron_web3_public_1 = require("src/core/blockchain/web3-public-service/web3-public/tron-web3-public/tron-web3-public");
...
class Web3PublicService {
    ...
    getWeb3Public(blockchainName) {
        if (!Web3PublicService.isSupportedBlockchain(blockchainName)) {
            throw new errors_1.PathrSdkError(`Blockchain ${blockchainName} is not supported in web3 public.`);
        }
        const web3Public = this.web3PublicStorage[blockchainName];
        if (!web3Public) {
            throw new errors_1.PathrSdkError(`Provider for ${blockchainName} was not initialized. Pass rpc link for this blockchain to sdk configuration object.`);
        }
        return web3Public;
    }
    setCreateWeb3Public() {
            ...
            get(target, prop) {
                ...
                if (typeof target[prop] === 'function') {
                    return async function method(...params) {
                        ...
                        if (!curRpc) {
                            throw new errors_1.PathrSdkError(`There is no working rpc left for ${blockchainName}.`);
                        }
                        const methodParams = (0, lodash_clonedeep_1.default)(params);
                        const callMethod = () => target[prop].call(target, ...params);
                        try {
                            const result = await (0, p_timeout_1.default)(callMethod(), rpcProvider.mainRpcTimeout ||
