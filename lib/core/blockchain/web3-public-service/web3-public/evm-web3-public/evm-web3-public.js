...
const healthcheck_1 = require("src/core/blockchain/constants/healthcheck");
...
const evm_multicall_abi_1 = require("src/core/blockchain/web3-public-service/web3-public/evm-web3-public/constants/evm-multicall-abi");
const tx_status_1 = require("src/core/blockchain/web3-public-service/web3-public/models/tx-status");
const web3_public_1 = require("src/core/blockchain/web3-public-service/web3-public/web3-public");
        ...
        if (this.multicallAddress) {
            try {
                ...
                return contractsData.map(contractData => contractData.methodsData.map(methodData => {
                    ...
                    if (!output) {
                        throw new errors_1.PathrSdkError('Output has to be defined');
                    }
                    outputIndex++;
                    return {
