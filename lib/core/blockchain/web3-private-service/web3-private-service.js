...
const web_private_supported_chain_type_1 = require("src/core/blockchain/web3-private-service/models/web-private-supported-chain-type");
const empty_web3_private_1 = require("src/core/blockchain/web3-private-service/web3-private/empty-web3-private");
const evm_web3_private_1 = require("src/core/blockchain/web3-private-service/web3-private/evm-web3-private/evm-web3-private");
const tron_web3_private_1 = require("src/core/blockchain/web3-private-service/web3-private/tron-web3-private/tron-web3-private");
...
class Web3PrivateService {
    ...
    getWeb3Private(chainType) {
        if (!Web3PrivateService.isSupportedChainType(chainType)) {
            throw new errors_1.PathrSdkError(`Chain type ${chainType} is not supported in web3 private`);
        }
    ...
    createEvmWeb3Private(evmWalletProviderCore) {
        ...
        const web3 = core;
        if (!web3) {
            throw new errors_1.PathrSdkError('Web3 is not initialized');
        }
