...
const proxy_hash_errors_1 = require("src/features/cross-chain/calculation-manager/providers/common/constants/proxy-hash-errors");
class EvmWeb3Private extends web3_private_1.Web3Private {
    ...
    static tryParseProxyError(err) {
        if ('data' in err) {
            ...
            if (error) {
                return new errors_1.PathrSdkError(error.text);
            }
        }
        return undefined;
    }
    ...
    async trySendTransaction(toAddress, options = {}) {
        try {
            ...
            try {
                ...
                throw new errors_1.PathrSdkError('Low native value');
            }
            const sendParams = {
                ...options,
                ...gasfulParams
