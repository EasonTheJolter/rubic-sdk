...
const chain_type_by_blockchain_1 = require("src/core/blockchain/utils/blockchains-info/constants/chain-type-by-blockchain");
/**
...
class BlockchainsInfo {
    ...
    static getChainType(blockchainName) {
        ...
        if (!chainType) {
            throw new errors_1.PathrSdkError(`No supported chain type for ${blockchainName}`);
        }
        return chainType;
    }
