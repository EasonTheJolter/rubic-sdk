...
const supportedBlockchains = [
    ...
    blockchain_name_1.BLOCKCHAIN_NAME.BOBA_AVALANCHE,
...
class CoingeckoApi {
    ...
    constructor(httpClient) {
        ...
        this.nativeCoinsCoingeckoIds = {
            ...
            [blockchain_name_1.BLOCKCHAIN_NAME.BOBA_AVALANCHE]: 'boba',
    ...
    async getNativeCoinPrice(blockchain) {
        if (!CoingeckoApi.isSupportedBlockchain(blockchain)) {
            throw new errors_1.PathrSdkError(`Blockchain ${blockchain} is not supported by coingecko-api`);
        }
        ...
        try {
            ...
            if (!price) {
                throw new errors_1.PathrSdkError('Coingecko price is not defined');
            }
    ...
    async getTokenPrice(token) {
        if (!CoingeckoApi.isSupportedBlockchain(token.blockchain)) {
            throw new errors_1.PathrSdkError(`Blockchain ${token.blockchain} is not supported by coingecko-api`);
        }
