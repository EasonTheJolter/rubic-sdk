...
const algebra_provider_1 = require("src/features/on-chain/calculation-manager/providers/dexes/polygon/algebra/algebra-provider");
const quick_swap_v3_provider_1 = require("src/features/on-chain/calculation-manager/providers/dexes/polygon/quick-swap-v3/quick-swap-v3-provider");
const quick_swap_v3_provider_2 = require("src/features/on-chain/calculation-manager/providers/dexes/polygon-zkevm/quick-swap-v3/quick-swap-v3-provider");
