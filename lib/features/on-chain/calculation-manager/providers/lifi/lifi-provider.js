...
const lifi_config_1 = require("src/features/common/providers/lifi/constants/lifi-config");
...
const lifi_forbidden_blockchains_1 = require("src/features/on-chain/calculation-manager/providers/lifi/constants/lifi-forbidden-blockchains");
const lifi_providers_1 = require("src/features/on-chain/calculation-manager/providers/lifi/constants/lifi-providers");
const lifi_trade_1 = require("src/features/on-chain/calculation-manager/providers/lifi/lifi-trade");
class LifiProvider {
    constructor() {
    ...
    async calculate(from, toToken, options) {
        if (this.isForbiddenBlockchain(from.blockchain)) {
            throw new errors_1.PathrSdkError('Blockchain is not supported');
        }
