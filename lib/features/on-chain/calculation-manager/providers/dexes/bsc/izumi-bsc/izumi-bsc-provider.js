...
const izumi_provider_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/izumi-abstract/izumi-provider");
    ...
    constructor() {
        ...
        this.config = {
            ...
            routingTokenAddresses: [
                ...
                tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN].address,
