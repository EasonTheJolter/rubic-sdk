...
const defaultCronosRoutingProvidersAddresses = [
    tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.CRONOS].address,
...
exports.defaultCronosProviderConfiguration = {
    ...
    wethAddress: tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.CRONOS].address
};
