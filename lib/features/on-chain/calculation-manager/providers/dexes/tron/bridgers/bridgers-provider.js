...
const bridgers_native_address_1 = require("src/features/common/providers/bridgers/constants/bridgers-native-address");
const to_bridgers_blockchain_1 = require("src/features/common/providers/bridgers/constants/to-bridgers-blockchain");
...
const on_chain_provider_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/on-chain-provider/on-chain-provider");
const tron_provider_default_options_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/on-chain-provider/tron-on-chain-provider/constants/tron-provider-default-options");
const tron_on_chain_provider_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/on-chain-provider/tron-on-chain-provider/tron-on-chain-provider");
const bridgers_trade_1 = require("src/features/on-chain/calculation-manager/providers/dexes/tron/bridgers/bridgers-trade");
class BridgersProvider extends tron_on_chain_provider_1.TronOnChainProvider {
    ...
    async calculate(from, toToken, options) {
        ...
        const cryptoFeeToken = new tokens_1.TokenAmount({
            ...tokens_1.nativeTokensList[from.blockchain],
