...
const constants_1 = require("src/features/on-chain/calculation-manager/providers/dexes/ethereum/uni-swap-v2-ethereum/constants");
class UniSwapV2EthereumTrade extends uniswap_v2_abstract_trade_1.UniswapV2AbstractTrade {
    constructor() {
        super(...arguments);
        this.dexContractAddress = constants_1.UNISWAP_V2_ETHEREUM_CONTRACT_ADDRESS;
    }
    static get type() {
