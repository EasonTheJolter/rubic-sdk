...
const quoter_contract_data_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-abstract/utils/quoter-controller/constants/quoter-contract-data");
...
const provider_configuration_1 = require("src/features/on-chain/calculation-manager/providers/dexes/scroll-sepolia/uni-swap-v3-scroll-sepolia/constants/provider-configuration");
const router_configuration_1 = require("src/features/on-chain/calculation-manager/providers/dexes/scroll-sepolia/uni-swap-v3-scroll-sepolia/constants/router-configuration");
const uni_swap_v3_scroll_sepolia_trade_1 = require("src/features/on-chain/calculation-manager/providers/dexes/scroll-sepolia/uni-swap-v3-scroll-sepolia/uni-swap-v3-scroll-sepolia-trade");
...
class UniSwapV3ScrollSepoliaProvider extends uniswap_v3_algebra_abstract_provider_1.UniswapV3AlgebraAbstractProvider {
    ...
    extractPath(route) {
        ...
        if (!initialPool) {
            throw new errors_1.PathrSdkError('Initial pool has to be defined');
        }
        const path = [
        ...
        if (!lastToken) {
            throw new errors_1.PathrSdkError('Last token has to be defined');
        }
