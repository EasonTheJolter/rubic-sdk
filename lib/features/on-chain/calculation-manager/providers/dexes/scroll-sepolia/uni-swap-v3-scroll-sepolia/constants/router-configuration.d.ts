 ...
 */
declare const tokensSymbols: readonly ["WETH", "USDC", "GHO"];
type TokenSymbol = (typeof tokensSymbols)[number];
export declare const UNI_SWAP_V3_SCROLL_SEPOLIA_ROUTER_CONFIGURATION: UniswapV3RouterConfiguration<TokenSymbol>;
export {};
