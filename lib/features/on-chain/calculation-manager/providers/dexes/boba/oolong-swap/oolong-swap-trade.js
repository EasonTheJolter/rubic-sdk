...
exports.OolongSwapTrade = void 0;
...
class OolongSwapTrade extends uniswap_v2_abstract_trade_1.UniswapV2AbstractTrade {
    constructor() {
        super(...arguments);
        this.dexContractAddress = constants_1.OOLONG_SWAP_CONTRACT_ADDRESS;
    }
    static get type() {
        return on_chain_trade_type_1.ON_CHAIN_TRADE_TYPE.OOLONG_SWAP;
    }
}
exports.OolongSwapTrade = OolongSwapTrade;
//# sourceMappingURL=oolong-swap-trade.js.map