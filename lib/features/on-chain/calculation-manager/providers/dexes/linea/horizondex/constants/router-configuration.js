...
exports.HORIZONDEX_UNISWAP_V3_SWAP_ROUTER_CONTRACT_ABI = exports.HORIZONDEX_UNISWAP_V3_SWAP_ROUTER_CONTRACT_ADDRESS = exports.HORIZONDEX_ROUTER_CONFIGURATION = void 0;
 ...
 */
const tokensSymbols = ['WETH', 'BNB', 'BUSD', 'MATIC', 'HZN', 'NFTE'];
const routerTokens = {
    WETH: tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.LINEA].address,
...
exports.HORIZONDEX_ROUTER_CONFIGURATION = {
    tokens: routerTokens,
    liquidityPools: routerLiquidityPools
};
exports.HORIZONDEX_UNISWAP_V3_SWAP_ROUTER_CONTRACT_ADDRESS = '0x272e156df8da513c69cb41cc7a99185d53f926bb';
exports.HORIZONDEX_UNISWAP_V3_SWAP_ROUTER_CONTRACT_ABI = [
    {
        inputs: [
