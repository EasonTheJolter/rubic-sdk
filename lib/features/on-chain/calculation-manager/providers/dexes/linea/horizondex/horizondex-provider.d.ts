...
export declare class HorizondexProvider extends UniswapV3AbstractProvider<HorizondexTrade> {
    ...
    readonly routerConfiguration: import("../../common/uniswap-v3-abstract/models/uniswap-v3-router-configuration").UniswapV3RouterConfiguration<"MATIC" | "BNB" | "BUSD" | "WETH" | "HZN" | "NFTE">;
