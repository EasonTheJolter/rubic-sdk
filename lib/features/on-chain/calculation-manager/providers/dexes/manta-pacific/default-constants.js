...
const defaultMantaPacificRoutingProvidersAddresses = [
    tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.MANTA_PACIFIC].address,
...
const defaultMantaPacificWethAddress = tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.MANTA_PACIFIC].address;
