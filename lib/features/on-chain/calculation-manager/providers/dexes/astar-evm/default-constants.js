...
const defaultAstarEvmRoutingProvidersAddresses = [
    tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.ASTAR_EVM].address,
...
const defaultAstarEvmWethAddress = tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.ASTAR_EVM].address;
