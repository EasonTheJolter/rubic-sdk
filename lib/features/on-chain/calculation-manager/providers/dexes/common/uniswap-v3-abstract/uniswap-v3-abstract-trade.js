...
const swap_router_contract_abi_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-abstract/constants/swap-router-contract-abi");
...
const uniswap_v3_algebra_abstract_trade_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-algebra-abstract/uniswap-v3-algebra-abstract-trade");
    ...
    getSwapRouterExactInputMethodData(walletAddress) {
        ...
        if (this.route.poolsPath.length === 1) {
            ...
            if (!this.route?.poolsPath?.[0]) {
                throw new errors_1.PathrSdkError('PoolsPath[0] has to be defined');
            }
            return {
                methodName,
                methodArguments: [
