...
exports.HorizondexUniswapV3QuoterController = void 0;
...
const uniswap_v3_quoter_controller_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-abstract/utils/quoter-controller/uniswap-v3-quoter-controller");
const quoter_contract_data_1 = require("src/features/on-chain/calculation-manager/providers/dexes/linea/horizondex/utils/quoter-controller/constants/quoter-contract-data");
class HorizondexUniswapV3QuoterController extends uniswap_v3_quoter_controller_1.UniswapV3QuoterController {
    constructor(blockchain, routerConfiguration) {
        super(blockchain, routerConfiguration, quoter_contract_data_1.HORIZONDEX_QUOTER_CONTRACT_ADDRESS, quoter_contract_data_1.HORIZONDEX_QUOTER_CONTRACT_ABI);
        this.feeAmounts = [8, 40, 300, 1000];
    }
    /**
    ...
    async getAllRoutes(from, to, exact, weiAmount, routeMaxTransitTokens) {
        ...
        return results
            ...
            if (!pool) {
                throw new errors_1.PathrSdkError('Pool has to be defined');
            }
            if (result.success) {
                return {
    ...
    getQuoterMethodsData(options, path, lastTokenAddress) {
        ...
        if (path.length === maxTransitTokens) {
            ...
            return pools.map(pool => HorizondexUniswapV3QuoterController.getQuoterMethodData(path.concat(pool), from, to, exact, weiAmount));
        }
...
exports.HorizondexUniswapV3QuoterController = HorizondexUniswapV3QuoterController;
__decorate([
    decorators_1.Cache
], HorizondexUniswapV3QuoterController, "getQuoterMethodData", null);
//# sourceMappingURL=horizondex-uniswap-v3-quoter-controller.js.map