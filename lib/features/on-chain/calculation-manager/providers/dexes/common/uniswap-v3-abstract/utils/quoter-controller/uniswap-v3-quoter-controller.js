...
const cache_decorator_1 = require("src/common/utils/decorators/cache-decorator/cache.decorator");
...
const factory_contract_data_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-abstract/utils/quoter-controller/constants/factory-contract-data");
...
const liquidity_pool_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-abstract/utils/quoter-controller/models/liquidity-pool");
const uniswap_v3_algebra_quoter_controller_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-algebra-abstract/models/uniswap-v3-algebra-quoter-controller");
/**
    ...
    async getAllLiquidityPools(firstToken, secondToken) {
        ...
        return poolsAddresses
            ...
            if (!poolMethodArguments) {
                throw new errors_1.PathrSdkError('Method arguments array for pool has to be defined');
            }
