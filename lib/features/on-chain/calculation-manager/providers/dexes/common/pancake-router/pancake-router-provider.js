...
const pancake_router_trade_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/pancake-router/pancake-router-trade");
...
class PancakeRouterProvider extends evm_on_chain_provider_1.EvmOnChainProvider {
    ...
    async calculate(from, to, options) {
        ...
        if (!trade) {
            throw new errors_1.PathrSdkError('');
        }
