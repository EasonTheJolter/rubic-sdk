...
const address_provider_abi_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/curve-provider/constants/address-provider-abi");
const registry_abi_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/curve-provider/constants/registry-abi");
const registry_exchange_abi_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/curve-provider/constants/registry-exchange-abi");
...
class CurveAbstractProvider extends evm_on_chain_provider_1.EvmOnChainProvider {
    ...
    async calculate(fromToken, toToken, options) {
        ...
        if ((0, blockchain_1.compareAddresses)(poolAddress, evm_web3_pure_1.EvmWeb3Pure.EMPTY_ADDRESS)) {
            throw new errors_1.PathrSdkError('Token is not supported.');
        }
