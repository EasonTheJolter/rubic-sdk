...
const constants_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/xy-dex-abstract/constants");
const xy_dex_trade_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/xy-dex-abstract/xy-dex-trade");
class XyDexAbstractProvider extends evm_on_chain_provider_1.EvmOnChainProvider {
    ...
    async getTradeInfo(from, toToken, options) {
        ...
        if (!trade.success || !trade.routes?.[0]) {
            throw new errors_1.PathrSdkError('Cant estimate trade');
        }
