...
const get_gas_fee_info_1 = require("src/features/on-chain/calculation-manager/providers/common/utils/get-gas-fee-info");
const evm_provider_default_options_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/on-chain-provider/evm-on-chain-provider/constants/evm-provider-default-options");
const evm_on_chain_provider_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/on-chain-provider/evm-on-chain-provider/evm-on-chain-provider");
const sync_swap_abstract_trade_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/sync-swap-abstract/sync-swap-abstract-trade");
const sync_swap_factory_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/sync-swap-abstract/utils/sync-swap-factory");
const sync_swap_path_factory_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/sync-swap-abstract/utils/sync-swap-path-factory");
const sync_swap_router_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/sync-swap-abstract/utils/sync-swap-router");
class SyncSwapAbstractProvider extends evm_on_chain_provider_1.EvmOnChainProvider {
    ...
    async calculate(from, toToken, options) {
        const fromAddress = options?.useProxy || this.defaultOptions.useProxy
            ? pathr_proxy_contract_address_1.pathrProxyContractAddress[from.blockchain].gateway
            : this.walletAddress;
        const fullOptions = (0, options_1.combineOptions)(options, {
            ...this.defaultOptions,
            fromAddress
        });
        const fromProxy = (0, token_native_address_proxy_1.createTokenNativeAddressProxy)(from, tokens_1.wrappedNativeTokensList[from.blockchain].address);
        const toProxy = (0, token_native_address_proxy_1.createTokenNativeAddressProxy)(toToken, tokens_1.wrappedNativeTokensList[from.blockchain].address);
