...
const estimated_gas_1 = require("src/features/on-chain/calculation-manager/providers/dexes/common/uniswap-v3-algebra-abstract/constants/estimated-gas");
...
class UniswapV3AlgebraAbstractTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    get defaultEstimatedGas() {
        ...
        if (!estimatedGas) {
            throw new errors_1.PathrSdkError('Default estimated gas has to be defined');
        }
