...
class SushiSwapArbitrumTrade extends uniswap_v2_abstract_trade_1.UniswapV2AbstractTrade {
    constructor() {
        super(...arguments);
        this.dexContractAddress = constants_1.SUSHI_SWAP_ARBITRUM_CONTRACT_ADDRESS;
    }
    static get type() {
