...
class OmnidexTrade extends uniswap_v2_abstract_trade_1.UniswapV2AbstractTrade {
    constructor() {
        super(...arguments);
        this.dexContractAddress = constants_1.OMNIDEX_CONTRACT_ADDRESS;
    }
    static get type() {
        return on_chain_trade_type_1.ON_CHAIN_TRADE_TYPE.OMNIDEX;
    }
}
exports.OmnidexTrade = OmnidexTrade;
//# sourceMappingURL=omnidex-trade.js.map