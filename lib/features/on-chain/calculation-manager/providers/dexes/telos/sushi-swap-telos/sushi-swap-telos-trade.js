...
exports.SushiSwapTelosTrade = void 0;
...
class SushiSwapTelosTrade extends uniswap_v2_abstract_trade_1.UniswapV2AbstractTrade {
    constructor() {
        super(...arguments);
        this.dexContractAddress = constants_1.SUSHI_SWAP_TELOS_CONTRACT_ADDRESS;
    }
    static get type() {
        return on_chain_trade_type_1.ON_CHAIN_TRADE_TYPE.SUSHI_SWAP;
    }
}
exports.SushiSwapTelosTrade = SushiSwapTelosTrade;
//# sourceMappingURL=sushi-swap-telos-trade.js.map