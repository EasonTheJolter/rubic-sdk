...
const price_token_amount_1 = require("src/common/tokens/price-token-amount");
...
class OpenOceanTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    get spenderAddress() {
        ...
        return this.useProxy
            ? pathr_proxy_contract_address_1.pathrProxyContractAddress[this.from.blockchain].gateway
            : openOceanContractAddress;
    }
    get dexContractAddress() {
        throw new errors_1.PathrSdkError('Dex address is unknown before swap is started');
    }
    ...
    async getTransactionData(receiverAddress) {
        ...
        const swapQuoteResponse = await injector_1.Injector.httpClient.get(apiUrl, {
            params: {
                ...
                gasPrice: isArbitrum
                    ...
                    : web3_pure_1.Web3Pure.fromWei(gasPrice, tokens_1.nativeTokensList[this.from.blockchain].decimals)
                        .multipliedBy(10 ** 9)
                        .toString(),
