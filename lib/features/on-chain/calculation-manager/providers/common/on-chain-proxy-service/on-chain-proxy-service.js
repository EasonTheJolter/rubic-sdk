...
class OnChainProxyService {
    ...
    async getFeeInfo(from, providerAddress) {
        ...
        const contractAddress = pathr_proxy_contract_address_1.pathrProxyContractAddress[fromBlockchain].router;
    ...
    static async handlePathrFee(web3Public, contractAddress) {
        const feeInfo = await Promise.all([
            ...
            web3Public.callContractMethod(contractAddress, evm_common_cross_chain_abi_1.evmCommonCrossChainAbi, 'PathrPlatformFee', [])
        ]);
        return {
