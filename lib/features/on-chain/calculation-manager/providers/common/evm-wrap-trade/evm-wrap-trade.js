...
const wrap_abi_1 = require("src/features/on-chain/calculation-manager/providers/common/evm-wrap-trade/wrap-abi");
...
class EvmWrapTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    static isSupportedTrade(blockchain, fromAddress, toAddress) {
        if (!EvmWrapTrade.isSupportedBlockchain) {
            throw new errors_1.PathrSdkError('Trade is not supported');
        }
