...
const scroll_bridge_supported_blockchain_1 = require("src/features/cross-chain/calculation-manager/providers/scroll-bridge/models/scroll-bridge-supported-blockchain");
const scroll_bridge_trade_1 = require("src/features/cross-chain/calculation-manager/providers/scroll-bridge/scroll-bridge-trade");
            ...
            if (!fromToken.isNative) {
                if (fromBlockchain === blockchain_name_1.BLOCKCHAIN_NAME.GOERLI) {
                    ...
                    if (!(0, blockchain_1.compareAddresses)(toToken.address, l2Address)) {
                        throw new errors_1.PathrSdkError('Swap is not allowed.');
                    }
                }
                else {
