...
const get_method_arguments_and_transaction_data_1 = require("src/features/cross-chain/calculation-manager/providers/bridgers-provider/utils/get-method-arguments-and-transaction-data");
...
const tron_native_swap_abi_1 = require("src/features/cross-chain/calculation-manager/providers/common/tron-cross-chain-trade/constants/tron-native-swap-abi");
const tron_cross_chain_trade_1 = require("src/features/cross-chain/calculation-manager/providers/common/tron-cross-chain-trade/tron-cross-chain-trade");
class TronBridgersCrossChainTrade extends tron_cross_chain_trade_1.TronCrossChainTrade {
    ...
    async swapDirect(options) {
        ...
        try {
            const fromWithoutFee = (0, get_from_without_fee_1.getFromWithoutFee)(this.from, this.feeInfo.pathrProxy?.platformFee?.percent);
