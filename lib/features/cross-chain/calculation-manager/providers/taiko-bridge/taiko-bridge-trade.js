...
class TaikoBridgeTrade extends evm_cross_chain_trade_1.EvmCrossChainTrade {
    ...
    async getContractParams() {
        ...
        if (this.fromBlockchain === blockchain_name_1.BLOCKCHAIN_NAME.SEPOLIA) {
            if (this.from.isNative) {
                methodArguments = [
                    {
                        id: 0,
                        from: account,
                        srcChainId: blockchain_id_1.blockchainId[blockchain_name_1.BLOCKCHAIN_NAME.SEPOLIA],
                ...
                methodArguments = [
                    {
                        ...
                        destChainId: blockchain_id_1.blockchainId[blockchain_name_1.BLOCKCHAIN_NAME.SEPOLIA],
                        user: account,
                        to: account,
                        refundTo: account,
                        value: this.from.stringWeiAmount,
