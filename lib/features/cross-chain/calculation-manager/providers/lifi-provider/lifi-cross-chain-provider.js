...
const lifi_cross_chain_supported_blockchain_1 = require("src/features/cross-chain/calculation-manager/providers/lifi-provider/constants/lifi-cross-chain-supported-blockchain");
const lifi_cross_chain_trade_1 = require("src/features/cross-chain/calculation-manager/providers/lifi-provider/lifi-cross-chain-trade");
const lifi_bridge_types_1 = require("src/features/cross-chain/calculation-manager/providers/lifi-provider/models/lifi-bridge-types");
...
class LifiCrossChainProvider extends cross_chain_provider_1.CrossChainProvider {
    ...
    async calculate(from, toToken, options) {
        ...
        if (options.lifiDisabledBridgeTypes?.length &&
            ...
            throw new errors_1.PathrSdkError('Incorrect bridges filter param');
        }
        ...
        if (!bestRoute) {
            throw new errors_1.PathrSdkError('No available routes');
        }
