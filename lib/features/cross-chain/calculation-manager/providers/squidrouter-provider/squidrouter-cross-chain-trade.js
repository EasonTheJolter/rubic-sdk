...
const squidrouter_contract_address_1 = require("src/features/cross-chain/calculation-manager/providers/squidrouter-provider/constants/squidrouter-contract-address");
...
class SquidrouterCrossChainTrade extends evm_cross_chain_trade_1.EvmCrossChainTrade {
    ...
    async getTransactionRequest(receiverAddress, transactionConfig, skipAmountChangeCheck = false) {
        ...
        const { route: { transactionRequest, estimate: routeEstimate } } = await injector_1.Injector.httpClient.get(`${squidrouter_cross_chain_provider_1.SquidrouterCrossChainProvider.apiEndpoint}route`, {
