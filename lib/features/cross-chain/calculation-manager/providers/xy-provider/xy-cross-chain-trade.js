...
const xy_contract_address_1 = require("src/features/cross-chain/calculation-manager/providers/xy-provider/constants/xy-contract-address");
        ...
        try {
            ...
            if (feeInfo.pathrProxy?.fixedFee?.amount.gt(0)) {
                ...
                const { data, value, to } = await new XyCrossChainTrade({
                    ...
                    feeInfo,
                    onChainTrade: null
                }, providerAddress || evm_web3_pure_1.EvmWeb3Pure.EMPTY_ADDRESS, []).getTransactionRequest(receiverAddress, undefined, true);
