...
const updated_rates_error_1 = require("src/common/errors/cross-chain/updated-rates-error");
...
const cross_chain_trade_1 = require("src/features/cross-chain/calculation-manager/providers/common/cross-chain-trade");
class EvmCrossChainTrade extends cross_chain_trade_1.CrossChainTrade {
    ...
    static checkAmountChange(transactionRequest, newWeiAmount, oldWeiAmount) {
