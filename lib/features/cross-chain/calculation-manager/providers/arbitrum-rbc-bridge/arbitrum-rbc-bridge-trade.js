...
const arbitrum_rbc_bridge_contract_address_1 = require("src/features/cross-chain/calculation-manager/providers/arbitrum-rbc-bridge/constants/arbitrum-rbc-bridge-contract-address");
const l1_erc20_gateway_abi_1 = require("src/features/cross-chain/calculation-manager/providers/arbitrum-rbc-bridge/constants/l1-erc20-gateway-abi");
const l2_erc20_gateway_abi_1 = require("src/features/cross-chain/calculation-manager/providers/arbitrum-rbc-bridge/constants/l2-erc20-gateway-abi");
const outbox_abi_1 = require("src/features/cross-chain/calculation-manager/providers/arbitrum-rbc-bridge/constants/outbox-abi");
const retryable_factory_abi_1 = require("src/features/cross-chain/calculation-manager/providers/arbitrum-rbc-bridge/constants/retryable-factory-abi");
...
const decode_method_1 = require("src/features/cross-chain/calculation-manager/utils/decode-method");
...
class ArbitrumRbcBridgeTrade extends evm_cross_chain_trade_1.EvmCrossChainTrade {
    ...
    static async claimTargetTokens(sourceTransaction, options) {
        ...
        if (!event) {
            throw new errors_1.PathrSdkError('Transaction is not ready');
        }
    ...
    static async redeemTokens(sourceTransactionHash, options) {
        ...
        if (!creationIdMessage) {
            throw new errors_1.PathrSdkError('Can not find creation id message.');
        }
