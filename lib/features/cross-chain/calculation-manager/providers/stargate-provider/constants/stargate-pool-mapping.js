...
exports.stargatePoolMapping = {
    [blockchain_name_1.BLOCKCHAIN_NAME.ETHEREUM]: {
        [stargate_bridge_token_1.stargateBridgeToken.USDC]: {
            [blockchain_name_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN]: [
                ...
                stargate_bridge_token_1.stargateBridgeToken.BUSD
            ],
        ...
        [stargate_bridge_token_1.stargateBridgeToken.USDT]: {
            ...
            [blockchain_name_1.BLOCKCHAIN_NAME.OPTIMISM]: [stargate_bridge_token_1.stargateBridgeToken.USDC],
            [blockchain_name_1.BLOCKCHAIN_NAME.FANTOM]: [stargate_bridge_token_1.stargateBridgeToken.FUSDC],
            [blockchain_name_1.BLOCKCHAIN_NAME.METIS]: [stargate_bridge_token_1.stargateBridgeToken.USDT]
        },
        ...
        [stargate_bridge_token_1.stargateBridgeToken.MAI]: {
            [blockchain_name_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.AVALANCHE]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.POLYGON]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.ARBITRUM]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.OPTIMISM]: [stargate_bridge_token_1.stargateBridgeToken.MAI]
        },
    ...
    [blockchain_name_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN]: {
        [stargate_bridge_token_1.stargateBridgeToken.USDT]: {
            [blockchain_name_1.BLOCKCHAIN_NAME.ETHEREUM]: [stargate_bridge_token_1.stargateBridgeToken.BUSD, stargate_bridge_token_1.stargateBridgeToken.USDT],
            [blockchain_name_1.BLOCKCHAIN_NAME.AVALANCHE]: [stargate_bridge_token_1.stargateBridgeToken.USDT, stargate_bridge_token_1.stargateBridgeToken.USDC],
            [blockchain_name_1.BLOCKCHAIN_NAME.POLYGON]: [stargate_bridge_token_1.stargateBridgeToken.USDT, stargate_bridge_token_1.stargateBridgeToken.USDC],
            [blockchain_name_1.BLOCKCHAIN_NAME.ARBITRUM]: [stargate_bridge_token_1.stargateBridgeToken.USDT, stargate_bridge_token_1.stargateBridgeToken.USDC],
            [blockchain_name_1.BLOCKCHAIN_NAME.OPTIMISM]: [stargate_bridge_token_1.stargateBridgeToken.USDC],
        ...
        [stargate_bridge_token_1.stargateBridgeToken.MAI]: {
            [blockchain_name_1.BLOCKCHAIN_NAME.ETHEREUM]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.AVALANCHE]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.POLYGON]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.ARBITRUM]: [stargate_bridge_token_1.stargateBridgeToken.MAI],
            [blockchain_name_1.BLOCKCHAIN_NAME.OPTIMISM]: [stargate_bridge_token_1.stargateBridgeToken.MAI]
    ...
    [blockchain_name_1.BLOCKCHAIN_NAME.METIS]: {
        ...
        [stargate_bridge_token_1.stargateBridgeToken.mUSD]: {
            [blockchain_name_1.BLOCKCHAIN_NAME.ETHEREUM]: [stargate_bridge_token_1.stargateBridgeToken.USDT],
            [blockchain_name_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN]: [stargate_bridge_token_1.stargateBridgeToken.USDT],
            [blockchain_name_1.BLOCKCHAIN_NAME.AVALANCHE]: [stargate_bridge_token_1.stargateBridgeToken.USDT]
        }
    },
