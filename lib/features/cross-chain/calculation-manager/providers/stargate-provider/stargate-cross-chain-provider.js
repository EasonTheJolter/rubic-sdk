...
const errors_2 = require("src/common/utils/errors");
...
const fee_library_abi_1 = require("src/features/cross-chain/calculation-manager/providers/stargate-provider/constants/fee-library-abi");
...
const stargate_factory_abi_1 = require("src/features/cross-chain/calculation-manager/providers/stargate-provider/constants/stargate-factory-abi");
const stargate_fee_library_contract_address_1 = require("src/features/cross-chain/calculation-manager/providers/stargate-provider/constants/stargate-fee-library-contract-address");
const stargate_pool_abi_1 = require("src/features/cross-chain/calculation-manager/providers/stargate-provider/constants/stargate-pool-abi");
...
const stargate_pool_mapping_1 = require("src/features/cross-chain/calculation-manager/providers/stargate-provider/constants/stargate-pool-mapping");
...
class StargateCrossChainProvider extends cross_chain_provider_1.CrossChainProvider {
    ...
    static hasDirectRoute(from, to) {
        ...
        if (!dstSupportedPools.includes(dstPoolId)) {
            throw new errors_1.PathrSdkError('Tokens are not supported.');
        }
    ...
    async calculate(from, toToken, options) {
        try {
            ...
            if ((0, blockchain_1.compareAddresses)(from.address, wrongFantomUsdc) ||
                ...
                throw new errors_1.PathrSdkError('Trade to this tokens is not allowed');
            }
    ...
    async getPoolToken(poolId, fromBlockchain) {
        ...
        if ((0, blockchain_1.compareAddresses)(poolAddress, evm_web3_pure_1.EvmWeb3Pure.EMPTY_ADDRESS)) {
            throw new errors_1.PathrSdkError('No possible pool');
        }
    ...
    static getSymbol(symbol, blockchain) {
